...
import {
  ...
  extractRpcUrls,
  injected
} from "./chunk-YQQMTOOF.js";
import {
  http,
  ripemd160,
  withRetry,
  withTimeout
} from "./chunk-5GNPFECZ.js";
import {
  Field,
  FpInvertBatch,
  FpLegendre,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-2ZV33T32.js");
